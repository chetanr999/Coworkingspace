                ...
                <div className="row mt-2 ms-lg-3 ms-md-3 ms-xl-5">
                  <div className="col-lg-12 col-md-12 p-1 d-flex">
                    <div className="dropdown">
                      <Link
                        className="btn dropdown-toggle border-white border-2 dropdowns fw-bold dropdowns-togle"
                        to="#"
                        role="button"
                        id="dropdownMenuLink"
                      ...
                      <ul
                        className="dropdown-menu mt-2 width-nav"
                    ...
                    <div className="dropdown ms-3">
                      <Link
                        className="btn dropdown-toggle border-2 border-light ms-4 dropdowns fw-bold dropdowns-togle"
                        to="#"
                        role="button"
                        id="dropdownMenuLink"
                        data-bs-toggle="dropdown"
                      ...
                      <ul
                        className="dropdown-menu menu-scroll mt-2 width-nav-city"
                        aria-labelledby="dropdownMenuLink"
                      >
                        {city.length > 0 ? (
                          city.map((e) => {
